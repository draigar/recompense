function fullScreenHeight() {
  ...
  !function (e, t, o) {
    ...
    o(e).on('scroll', function () {
      o(this).scrollTop() > 0 ? o('.header-desktop').addClass('scrolling-menu') : o('.header-desktop').removeClass('scrolling-menu'),
      o(this).scrollTop() > 100 ? o('#backtotop').addClass('show') : o('#backtotop').removeClass('show')
    }),
    o(t).ready(function (o) {
      ...
      o('#open-left').on('click', function (e) {
        o('.site').addClass('open'),
        o('.slideout-menu').addClass('open')
      }),
